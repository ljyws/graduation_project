...
void Controller::set_error(error_e error)
{
...
bool Controller::update()
{
    ...
    switch (config_.input_mode)
    {
        ...
        case INPUT_MODE_MIRROR:
        {
            ...
            // {
                // std::optional<float> other_pos = axis[config_.axis_to_mirror].encoder_.pos_estimate_.present();
        ...
        case INPUT_MODE_TUNING:
        {
            ...
            float c = arm_cos_f32(autotuning_phase_);
            float s = arm_sin_f32(autotuning_phase_);
    ...
    if (config_.enable_overspeed_error)
    {
